 ...
 * @since		2.0
 */
class BackendLinkCheckerAjaxRefreshLinksWidget extends BackendBaseAJAXAction
{
	/**
	 * All links found
	 *
	...
	private function parseAll()
	{
		...
		if(!empty($results))
		{
			...
			$datagrid->setColumnFunction(array('BackendLinkCheckerAjaxRefreshLinksWidget', 'getModuleLabel'), array('[module]'), 'module', true);
		}
